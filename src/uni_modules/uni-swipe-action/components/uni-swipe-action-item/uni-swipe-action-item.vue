      ...
      >
        ...
        <view class="uni-swipe_button-group button-group--left">
          <slot name="left">
            ...
            >
              <text class="uni-swipe_button-text" :style="{ color: item.style && item.style.color ? item.style.color : '#FFFFFF', fontSize: item.style && item.style.fontSize ? item.style.fontSize : '16px' }">{{ item.text }}</text>
            </view>
          </slot>
        </view>
