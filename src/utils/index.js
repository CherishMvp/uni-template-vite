 ...
 * @returns
 */
export const createVariableProps = (propNames, { prefix = 'scope', emitUpdate = true, setCallback = null } = {}) => ({
...
// 字典映射
export const mapDict = function (data, { childrenName = 'children', keyName = 'value', valueName = 'label', mapValue } = {}) {
