...
import { baseURL, timeout, responseSuccessCode, useEncrypt } from '@/configs/request.js';
...
service.interceptors.response.use(
  async (response) => {
    ...
    if (res.code === '1005' || res.code === '1006' || res.code === '1000' || (res.code === '1010' && response.config.url.indexOf('/login') === -1)) {
      const userStore = store.useUserStore();
